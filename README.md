...
To participate in the challenge, submit your model between **June 22nd** and **July 5th 2026** using [this form](https://forms.gle/d8KdNVxfPm3UmGcW6). To ensure your submission is accepted, please provide full, merged model weights (LoRA adapters **must be merged** into the base model before submission)! Also provide a model training card that covers: training methodology, data usage breakdown, hyperparameters, compute budget, and any design decisions relevant to reproducibility.
